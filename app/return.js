    ...
    return (
        <ImageBackground source={require('../assets/image/back.png')} style={styles.container}>
            <View style={styles.main}>
                ...
                <Text style={styles.subtitle}>Scannez le livre a rendre</Text>
                <QRCodeReader nextpath={'bookReturn'} previousId={id} userId={userId}/>
                <Text style={styles.subtitle}>Box de {users.city}</Text>
                <Pressable style={styles.button}>
                    <Link href={{ pathname: 'box' , params: { id: id }}}>Emprunté un livre</Link>
                </Pressable>
            </View>
        </ImageBackground>
    );
